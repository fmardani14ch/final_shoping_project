...
class LATEST_PRODUCT extends StatefulWidget {
  @override
  State<LATEST_PRODUCT> createState() => _LATEST_PRODUCTState();
  const LATEST_PRODUCT({super.key});
}
...
class _LATEST_PRODUCTState extends State<LATEST_PRODUCT> {
  ...
  void initState() {
    ...
    BlocProvider.of<ProductBloc>(context).add(LATEST_PRODUCT_START());
  }
      ...
      body: Container(
        child: BlocBuilder<ProductBloc, ProductState>(
          builder: (context, state) {
            if (state is LATEST_PRODUCT_SUCCESS) {
              return Container(
                          ...
                          children: [
                            Stack(
                              children: [
                                ...
                                IconButton(
                                    onPressed: () async {
                                      if (FAVORITE_PRODUCT.isinbox(product)) {
                                        setState(() {
                                          FAVORITE_PRODUCT
                                        ...
                                        setState(() {
                                          FAVORITE_PRODUCT.add_product(product);
                                        });
                                      }
                                    },
                                    icon: FAVORITE_PRODUCT.isinbox(product)
                                        ? Icon(
            ...
            } else if (state is LATEST_PRODUCT_ERROR) {
              return Center(
